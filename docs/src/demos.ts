...
export function confetti(source: party.util.Source): void {
    party.confetti(source, {
        size: party.variation.range(0.6, 1),
    });
}

export function sparkles(source: party.util.Source): void {
    party.sparkles(source);
}

export function hearts(source: party.util.Source): void {
